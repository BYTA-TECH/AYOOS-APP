...
import { ReservedSlotDTO } from 'src/app/api/models';
...
export class DoctorBookingPage implements OnInit {
  ...
  datePick: string;
  slotsMorningSession: ReservedSlotDTO[] = [];
  slotsAfternoonSession: ReservedSlotDTO[] = [];
  slotsEveningSession: ReservedSlotDTO[] = [];
  ...
  ngOnInit() {
    ...
    this.queryResourceService
      .findDoctorByDoctorIdUsingGET(this.doctorId)
      .subscribe(result => {
        this.doctor = result;
